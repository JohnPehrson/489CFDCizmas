function [delta_t] = time_step(c,CFL,cell_area,x_abcd,y_abcd,q3by3)
...
sumeigenvaluefaces = eigenvalueDis(c,x_abcd,y_abcd,q3by3,'N')*edgelength(x_abcd,y_abcd,'N')+...
                     eigenvalueDis(c,x_abcd,y_abcd,q3by3,'E')*edgelength(x_abcd,y_abcd,'E')+...
                     eigenvalueDis(c,x_abcd,y_abcd,q3by3,'S')*edgelength(x_abcd,y_abcd,'S')+...
