...
%function to refresh all boundary conditions. 
    [cells_q,cells_f,cells_g] = applyUpperWallBC(user_Gamma,nodes_x,nodes_y,cells_q,cells_f,cells_g,cells_Imax,cells_Jmax);
    [cells_q,cells_f,cells_g] = applyBottomWallBC(user_Gamma,nodes_x,nodes_y,cells_q,cells_f,cells_g,cells_Imax);
