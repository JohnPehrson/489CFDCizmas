...
user_itmax = 4000;            %maximum number of iterations made when solving
...
fprintf('Force in the x direction is %s', num2str(plot_bump_force(user_itmax+1,1)));
fprintf('\n');
fprintf('Force in the y direction is %s', num2str(plot_bump_force(user_itmax+1,2)));
