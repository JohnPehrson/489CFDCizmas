...
it_plot_frequency = 10;     %After how many iterations do I save data for plotting? Aka, 10 means every 10 iterations I should save the data
...
cells_c = cells_eig;                                %speed of sound for individual cells
...
%iterations)
it_plot_reduced = ceil(user_itmax/it_plot_frequency);
plot_cells_q = NaN(1+it_plot_reduced,cells_Imax,cells_Jmax,4); %The 1+plot_it_reduced is for bc, then the iterations
...
[cells_q,cells_f,cells_g,cells_pressure,cells_eig,cells_c] = setInitialConditions(user_Mach,user_Gamma,user_alpha,P_static,cells_q,cells_f,cells_g,cells_pressure,cells_eig,cells_c,cells_Imax,cells_Jmax,nodes_x,nodes_y);
